...
/**
 * Escalon de la progresion segun una fraccion `progress` (0-1): 0 -> el mas facil, 1 -> el
 * movimiento objetivo. Primitiva pura; el motor (`resolveSkillProgression`) es quien calcula esa
 * fraccion combinando competencia real, calendario y nivel de partida declarado.
 */
